...
if ( ! function_exists( 'school_theme_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function school_theme_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'school-theme' ),
...
if ( ! function_exists( 'school_theme_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function school_theme_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'school-theme' ),
...
if ( ! function_exists( 'school_theme_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function school_theme_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'school-theme' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'school_theme_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function school_theme_post_thumbnail() {
